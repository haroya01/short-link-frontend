  ...
  return (
    ...
    >
      <div className="flex flex-col items-start gap-3 sm:flex-row sm:items-center sm:gap-4">
        <span className="grid h-10 w-10 flex-shrink-0 place-items-center rounded-lg bg-white dark:bg-slate-900 text-accent-700 dark:text-accent-400 shadow-[0_1px_2px_rgba(15,23,42,0.04)] ring-1 ring-accent-200/60">
