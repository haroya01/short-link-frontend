...
export function BlogBottomNav() {
  ...
  return (
    <>
      <nav
        className={cn(
          "vt-bottom-nav glass-chrome glass-lip fixed inset-x-0 bottom-0 z-40 flex overflow-visible border-t border-slate-200/60 pb-[env(safe-area-inset-bottom)] transition-transform duration-200 motion-reduce:transition-none dark:border-slate-800/60 sm:hidden",
