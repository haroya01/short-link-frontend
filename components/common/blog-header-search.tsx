  ...
  return (
    <form ref={formRef} onSubmit={submit} role="search" className="relative">
      ...
      {value.trim() && panelOpen && (
        <div className="absolute right-0 top-full z-40 mt-2 w-80 max-w-[85vw] overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-lg dark:border-slate-700 dark:bg-slate-900">
