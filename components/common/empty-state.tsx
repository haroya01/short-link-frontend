...
export function EmptyState({ icon: Icon = Inbox, title, description, action, className }: Props) {
  return (
    <div
      className={cn(
        "flex flex-col items-center justify-center rounded-lg border border-dashed border-slate-200 bg-white px-6 py-16 text-center",
        className,
      )}
    >
      <div className="relative mb-5">
        ...
        <svg
          className="absolute -left-3 -top-2 h-3 w-3 text-slate-200"
          viewBox="0 0 12 12"
          fill="currentColor"
          aria-hidden
        >
        ...
        <svg
          className="absolute -right-2 bottom-0 h-2 w-2 text-slate-200"
          viewBox="0 0 8 8"
          fill="currentColor"
          aria-hidden
        >
