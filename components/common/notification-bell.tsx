...
function NotificationDropdown({
  ...
  return (
    <div
      role="menu"
      className={`absolute right-0 z-30 mt-2 w-80 origin-top-right overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-lg dark:border-slate-800 dark:bg-slate-950 ${
