...
- serif 표면 규칙: 웨이트는 **600/700 만**(그 둘만 로드, `globals.css` `@font-face`), 자간은 `tracking-display`(-0.01em — `tracking-headline`/`tracking-tight` 는 Pretendard 기준이라 세리프엔 과함), 14px 이하 밀집 리스트(레일·에피소드 목록 등)는 sans 유지.
