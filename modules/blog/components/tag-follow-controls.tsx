...
export function TagFollowControls({ tag }: { tag: string }) {
  ...
  return (
    <div className="mt-3 flex items-center gap-2">
      ...
      >
        <span key={followed ? "on" : "off"} className="subscribe-pop inline-flex items-center gap-1.5">
      ...
      >
        <span key={hidden ? "on" : "off"} className="subscribe-pop inline-flex items-center gap-1.5">
