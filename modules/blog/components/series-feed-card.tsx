  ...
  return (
    ...
    <section className="group/series mark-hoverable" aria-label={series.title}>
      ...
      <BlogLink href={seriesUrl} className="focus-ring group/title mt-1 block rounded">
        <h3 className="line-clamp-2 font-serif text-[20px] font-bold leading-snug tracking-display text-slate-900 transition-colors group-hover/title:text-accent-700 dark:text-slate-100 dark:group-hover/title:text-accent-400">
          {series.title}
        </h3>
      </BlogLink>
