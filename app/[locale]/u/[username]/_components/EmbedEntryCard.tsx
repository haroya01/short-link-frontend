 ...
 * {@link withAutoplay} dispatches on host.
 */
      ...
      >
        <div className="relative aspect-video w-full bg-slate-100">
          ...
          {active && meta?.html ? (
            ...
            // (YouTube/Vimeo/Spotify/SoundCloud); we render it raw so embeds keep working as
            // providers tweak attrs. The autoplay rewrite is purely a query-param swap on iframe
            // src — doesn't touch any other attribute or script.
            <div
