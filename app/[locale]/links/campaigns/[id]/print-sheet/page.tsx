...
type Layout = {
  id: "comfortable" | "standard" | "dense";
  cols: number;
  rows: number;
};

const LAYOUTS: Layout[] = [
  { id: "comfortable", cols: 3, rows: 4 },
  { id: "standard", cols: 4, rows: 5 },
  { id: "dense", cols: 5, rows: 6 },
];
  ...
  return (
    <div className="space-y-3 rounded-2xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 px-4 py-4">
      ...
      <div className="flex flex-wrap items-center gap-3">
        <Toggle label={t("showLabel")} checked={showLabel} onChange={onShowLabelChange} />
        <Toggle label={t("cutMarks")} checked={showCutMarks} onChange={onShowCutMarksChange} />
        <Toggle
          label={t("pagePerBatch")}
...
function Toggle({
  ...
  return (
    <label className="inline-flex items-center gap-2 rounded-lg border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 px-3 py-2 hover:bg-slate-50 dark:hover:bg-slate-800/50">
      <input
        type="checkbox"
        checked={checked}
